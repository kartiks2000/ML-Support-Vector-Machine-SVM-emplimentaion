...
# FittingSUPPORT VECTOR MACHINE model to the Training Set
from sklearn.svm import SVC
# We have to pass the kernel which we want to use
...
# Predicting result with SUPPORT VECTOR MACHINE
...
# Visualising the SUPPORT VECTOR MACHINE results
